...
<div class="bs-example">
    <form action="UpdateWProfile.jsp">
            ...
            <div class="col-sm-10">
                <input type="email" class="form-control" id="wid" name="wid" value="<%=w.getWid() %>" readonly/>
            </div>
        </div>
    	...
    	<div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="wname" name="wname" value="<%=w.getWname() %>" required>
            </div>
        </div>        
